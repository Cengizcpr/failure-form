...
{this.state.showMe2?  <Printer>
  ...
  <div className="container" id={ids[0]} style={{  width:'210mm', height: '297mm'}}>
  <div className="row">
      ...
      <div className="card">
        ...
        <th >{this.state.fnote}</th>
          ...
          <div className="d-flex flex-row-reverse bg-dark text-white p-4">
            ...
            <div className="mb-2">Fiyat</div>
                            <div className="h2 font-weight-light">{this.state.fprice}+KDV</div>
            </div>
